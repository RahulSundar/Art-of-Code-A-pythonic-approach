...
def binary_en_rec(number,code, binary_en_rec, base_number=2):
    if int(number)==0: 
        code += str(0) 
        return code 
    else: 
        remainder = int(number % base_number) 
        quotient = int((number - remainder)/base_number) 
        print(quotient, remainder) 
        return  str(binary_en_rec(quotient, base_number, code+str(remainder)))  
